...
const cats = [
	...
	{label: "劳动纠纷", uri: "/zhishi/laodongjiufen/"},
	{label: "治安管理处罚法", uri: "/zhishi/zaglcff/"},
	{label: "公司法", uri: "/zhishi/gongsifa/"},
	{label: "知识产权", uri: "/zhishi/zhishichanquan/"},
	{label: "经济仲裁", uri: "/zhishi/jingjizhongcai/"},
	{label: "国际贸易", uri: "/zhishi/guojimaoyi/"},
	{label: "遗产继承", uri: "/zhishi/yichanjicheng/"},
	{label: "交通事故", uri: "/zhishi/jiaotongshigu/"},
	{label: "财税法律", uri: "/zhishi/caishuifalv/"},
	{label: "拆迁安置", uri: "/zhishi/chaiqiananzhi/"},
	{label: "医疗事故", uri: "/zhishi/yiliao/"},
	{label: "损害赔偿", uri: "/zhishi/sunhaipeichang/"},
	{label: "债权债务", uri: "/zhishi/zhaiquanzhaiwu/"},
	{label: "人身损害", uri: "/zhishi/renshensunhai/"},
	{label: "抵押担保", uri: "/zhishi/diyadanbao/"},
	{label: "保险理赔", uri: "/zhishi/baoxianlipei/"},
	{label: "不当竞争", uri: "/zhishi/budangjingzheng/"},
	{label: "刑事辩护", uri: "/zhishi/xingshibianhu/"},
	{label: "取保候审", uri: "/zhishi/qubaohoushen/"},
	{label: "刑事自诉", uri: "/zhishi/xingshizisu/"},
	{label: "国家赔偿", uri: "/zhishi/guojiapeichang/"},
	{label: "破产清算", uri: "/zhishi/pochanqingsuan/"},
	{label: "行政法", uri: "/zhishi/xingzhengfa/"},
	{label: "工程建筑", uri: "/zhishi/gongchengjianzhu/"},
	{label: "消费维权", uri: "/zhishi/xiaofeiweiquan/"},
	{label: "公证法", uri: "/zhishi/gongzhengfa/"},
	{label: "法律讲堂", uri: "/zhishi/falvjiangtang/"},
	{label: "侵权责任法", uri: "/zhishi/qqzrf/"},
	{label: "职业病防治法", uri: "/zhishi/zhybfzhif/"},
	{label: "房产纠纷", uri: "/zhishi/fangchanjiufen/"},
	{label: "招标投标", uri: "/zhishi/zhaobiaotoubiao/"},
	{label: "合同法", uri: "/zhishi/hetongfa/"},
	{label: "仲裁法", uri: "/zhishi/zhongcaifa/"},
	{label: "物权法", uri: "/zhishi/wuquanfa/"},
	{label: "合伙加盟", uri: "/zhishi/hehuojiameng/"},
	{label: "行政诉讼法", uri: "/zhishi/xingzhengsusongfa/"},
	{label: "行政复议法", uri: "/zhishi/xingzhengfuyifa/"},
	{label: "刑事诉讼法", uri: "/zhishi/xingshisusongfa/"},
	{label: "电子商务", uri: "/zhishi/dianzishangwu/"},
	{label: "海事海商", uri: "/zhishi/haishihaishang/"},
	{label: "行政处罚法", uri: "/zhishi/xingzhengchufafa/"},
	{label: "行政许可法", uri: "/zhishi/xingzhengxukefa/"},
	{label: "法律案例", uri: "/falvanli/"},
	{label: "法律文书", uri: "/falvwenshu/"},
	{label: "律师营销", uri: "/lvshiyingxiao/"},
	{label: "合同范本", uri: "/hetongfanben/"},
	{label: "法律援助", uri: "/falvyuanzhu/"},
	{label: "诉讼指南", uri: "/susongzhinan/"},
	{label: "金融证券", uri: "/zhishi/jinrongzhengquan/"},
	{label: "法律论文", uri: "/falvlunwen/"}
];
